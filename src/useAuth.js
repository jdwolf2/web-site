...
Amplify.configure({
  Auth: {
    ...
    oauth: {
      ...
      redirectSignIn: 'https://accusalt-mobile.netlify.app/',
      redirectSignOut:'https://accusalt-mobile.netlify.app/',
      responseType: 'code',
    },
  },
})
...
export function useAuth() {
  ...
  function signIn() {
    ...
    const redirectUri = encodeURIComponent('https://accusalt-mobile.netlify.app/')
